            ...
            <form method="post" action="postad.php" enctype="multipart/form-data">
              <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                  ...
                  <select id="adCategory" class="form-select" name="category_id">
                ...
                <div class="col-12">
                  ...
                  <textarea id="adDescription" class="form-control" name="description" rows="6" placeholder="Tulis deskripsi lengkap tentang iklan Anda..."><?php echo htmlspecialchars($old['description'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                </div>
                ...
                <div class="col-12 col-md-6">
                  ...
                  <input type="text" class="form-control" id="adLocation" name="location" placeholder="Kota/Kabupaten" value="<?php echo htmlspecialchars($old['location'], ENT_QUOTES, 'UTF-8'); ?>">
                </div>
                ...
                <div class="col-12 d-flex gap-2 mt-2">
                  <button type="button" class="btn btn-outline-secondary" disabled><i class="bi bi-eye me-1"></i>Pratinjau</button>
